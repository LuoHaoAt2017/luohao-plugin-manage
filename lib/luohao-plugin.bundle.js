...
if (require('./_descriptors') && (!CORRECT_NEW || require('./_fails')(function () {
  ...
  $RegExp = function RegExp(p, f) {
    ...
    var piRE = isRegExp(p);
    var fiU = f === undefined;
    return !tiRE && piRE && p.constructor === $RegExp && fiU ? p : inheritIfRequired(CORRECT_NEW ? new Base(piRE && !fiU ? p.source : p, f) : Base((piRE = p instanceof $RegExp) ? p.source : p, piRE && fiU ? $flags.call(p) : f), tiRE ? this : proto$1, $RegExp);
  };
  ...
  require('./_redefine')(global$2, 'RegExp', $RegExp);
}
...
$export$2($export$2.S + $export$2.F * (NEW_TARGET_BUG || ARGS_BUG), 'Reflect', {
  ...
  /* , newTarget */
    ...
    var instance = create(isObject$1(proto) ? proto : Object.prototype);
